...
export default function MatchHeader({ match }: { match: Match }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[#1f1f1f] bg-[#111] p-6 md:p-8">
      {/* Background glow */}
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-3 items-center gap-4 mb-6">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="w-14 h-14 rounded-2xl border border-[#1f1f1f] bg-[#0a0a0a] flex items-center justify-center">
