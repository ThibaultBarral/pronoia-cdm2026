  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#1a1a1a] bg-[#0a0a0a]/95 backdrop-blur-sm">
      <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <Link
          href="/dashboard"
          className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-[#00ff88] text-[#0a0a0a] text-sm font-bold hover:bg-[#00cc6a] transition-all hover:scale-105 glow-neon"
        >
          <Zap size={13} />
          Se connecter
        </Link>
