...
export const LOCKED_TEASERS: LockedTeaser[] = [
  {
    ...
    body: "Le combiné IA du jour — 2 à 3 pronos haute confiance avec la cote totale — arrive très bientôt, réservé aux membres. Débloque-le dès 2,99 €/sem, ou 8,99 €/mois en analyses illimitées.",
  },
  {
    id: "chat_ia",
    label: "Chat IA",
    title: "Le Chat IA est réservé aux membres",
    body: "Pose tes questions à l'IA sur n'importe quel match et obtiens une réponse claire en quelques secondes. Inclus dès le Mensuel à 8,99 €/mois en illimité (ou teste à 2,99 €/sem).",
  },
];
