export function GET(request: Request) {
  ...
  // Palette is the electric-blue brand gradient (#2563EB → #4F8CFF → #8EC5FF).
  ...
  <rect width="120" height="120" rx="28" fill="#050A1F"/>
  ...
  <path d="M60 66 c6 4 9 9 9 15 c0 8 -7 13 -14 13 c-6 0 -11 -5 -11 -12 c0 -6 4 -11 8 -15 c0 4 2 6 5 6 c3 0 5 -3 4 -7 z" fill="#050A1F" opacity="0.45"/>
</svg>`;
