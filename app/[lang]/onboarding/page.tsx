          ...
          <StepShell key="s2" width="max-w-2xl">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-[var(--text-muted)] mt-2">
                Les matchs de {nation?.name} passent en premier. Ta première analyse est offerte.
              </p>
            </div>
  ...
  return (
    <StepShell width="max-w-md">
      <div className="text-center flex flex-col items-center">
        ...
        <h1 className="text-2xl md:text-3xl font-black text-[var(--text)]">Passe en Premium</h1>
        <p className="text-sm text-[var(--text-muted)] mt-2 max-w-sm">
          Le résultat, c&apos;est gratuit. Le <span className="text-[var(--text)] font-semibold">comment</span> — buteurs,
          score exact, scénario — c&apos;est Premium.
        </p>
        ...
        >
          Voir mon analyse offerte <ArrowRight size={16} />
        </button>
        <button
          onClick={onPricing}
        ...
        >
          <ListChecks size={14} /> Voir les offres Premium
        </button>
      </div>
    </StepShell>
  );
